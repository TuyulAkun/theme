...
installTheme(){
    ...
    rm -r Utama
    git clone https://github.com/TuyulAkun/Utama.git
    cd Utama
...
repair(){
    bash <(curl https://raw.githubusercontent.com/TuyulAkun/Utama/main/repair.sh)
}
...
echo ""
echo "Wa: +63 838-9414-5941"
echo "Nama: FikiXdOfficial"
echo ""
